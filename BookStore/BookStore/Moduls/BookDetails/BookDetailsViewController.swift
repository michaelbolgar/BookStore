...
final class BookDetailsViewController: UIViewController {
    ...
    private lazy var authorLabel = UILabel(text1: "Author: ", text2: BookModel.authorName)
    private lazy var categoryLabel = UILabel(text1: "Category: ", text2: BookModel.category)
    private lazy var raitingLabel = UILabel(text1: "Raiting: ", text2: BookModel.raiting)
    ...
    private lazy var descriptionTextView: UITextView = {
        ...
        element.text = BookModel.descriptionText
