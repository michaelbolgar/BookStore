...
struct BookDetailsModel {
    ...
    var title: String = ""
    static var authorName: String = "Oscar Wilde"
//    var authorName: String = "Oscar Wilde"
    var hasFullText: Bool = true
    var ia: String = ""
    static var category: String = "Classics"
//    var category: String = "Classics"
    static var raiting: String = "4.11/5"
