...
class SearchCell: UICollectionViewCell {
    ...
    private lazy var genreLabel = UILabel.makeLabel(font:.openSansLight(ofSize: 10), textColor: .lightGray)
    ...
    private func setupUI() {
        addSubviews(backgroundBookView)
        backgroundBookView.addSubviews(bookImage,infoBackgroundView)
        infoBackgroundView.addSubviews(genreLabel,nameLabel,authorLabel)
